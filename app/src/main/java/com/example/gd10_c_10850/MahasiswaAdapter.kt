package com.example.gd10_c_10850
...
import com.example.gd10_c_10850.databinding.ListDataMahasiswaBinding
        ...
        fun bind(mahasiswaData: MahasiswaData){
            with(binding) {
                ...
                cvData.setOnClickListener {
                    var i = Intent(context, DetailMahasiswaActivity::class.java).apply { putExtra("nim",mahasiswaData.nim)
                    }
